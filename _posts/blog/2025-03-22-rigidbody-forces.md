...
![Showcasing the APC in action](/01-movement-c02.gif?updatedAt=1742422948119)
...
![Flow chart explaining reverse integration in Godot](/2025-03-22-rigidbody-forces/02.png)
...
![Test showing the effect of contact forces with changing gravity](/2025-03-22-rigidbody-forces/06.gif)
...
![Diagram depicting general equations for reverse integration](/2025-03-22-rigidbody-forces/04.png){: w="400" }

![Diagram depicting different free body states for a floating capsule](/2025-03-22-rigidbody-forces/03.png){: w="400" }
_The above contains free body diagrams depicting states of a floating capsule rigidbody_

![Slope approximation](/2025-03-22-rigidbody-forces/01.png){: w="400" }
...
![A debug implementation of OneEuro in 2D](/2025-03-22-rigidbody-forces/05.gif)
_A debug implementation of OneEuro in 2D created to get a better understanding_

![Test showing contact forces when using a filter](/2025-03-22-rigidbody-forces/07.gif)
_The output of OneEuro from contact forces as shown with a purple visual indicator_

![Test showing an artificial gravity situation](/2025-03-22-rigidbody-forces/08.gif?updatedAt=1742709062092)
